...
public class BookingController {
	...
	public boolean f1(@RequestBody Book booking)
	{
		boolean res=bookingDao.addBooking(booking.getUserId(),booking.getVenueId(),booking.getPackageId(),booking.getDate(),booking.getAmount());
		if(res)
		{
			return true;
		}else return false;
