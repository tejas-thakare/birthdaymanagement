                        ...
                        <div className="carousel-item active" style={{backgroundImage: 'url("img/slide/slide-1.jpg")'}}>
                            <div className="carousel-container">
                                <div className="carousel-content">
                                    ...
                                    <p className="animate__animated animate__fadeInUp">This is a day of celebration not only because of your special day. It is also the day we give thanks for having you in our lives. You are a blessing.</p>
                                    <div>
                                         <Link to="/packages" className="btn-menu animate__animated animate__fadeInUp scrollto">Our Packages</Link>
                                        <Link to="/SignInUser" className="btn-book animate__animated animate__fadeInUp scrollto">Book an Event</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
